...
ECHO.
ECHO Usage:
ECHO %~nx0 [Clean^|Build^|Rebuild] [x86^|x64^|Both] [Main^|Resources^|MPCHC^|IconLib^|Translations^|Filters^|API^|All] [Debug^|Release] [Lite] [Packages^|Installer^|7z] [LAVFilters] [VS2017^|VS2019] [Analyze]
ECHO.
...
ECHO "%~nx0 Build Both MPCHC Release VS2017"
ECHO. & ECHO.
ECHO Examples:
